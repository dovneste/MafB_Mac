...
MafB_target_sign <- MafB_Peaks$`Gene Name`
MafB_target_sign <- intersect(MafB_target_sign, rownames(tbms))
tbms <- AddModuleScore(tbms, features = list(c(MafB_target_sign)), name = "MafB_target_sign")
```
