...
# Load Seurat object
```{r}
tbms <- readRDS(file = "/media/uliege/T7/SingleCellAtlas/tbms.rds")
```
...
table_counts <- table(tbms_myeloid@active.ident, tbms_myeloid$tissue)

# Convert to proportions (percentages)
table_percent <- prop.table(table_counts, margin = 1) * 100
