...
Sc_Macro_filter$Condition[(Sc_Macro_filter$orig.ident == "HT5-Control")] <- "IM WT" 
Sc_Macro_filter$Condition[(Sc_Macro_filter$orig.ident == "HT7-MAFb-KO")] <- "IM KO" 
